...
public final class CauseData {
    ...
    CauseData(ActionType actionType, Integer sourceProjectId, Integer targetProjectId, String branch, String sourceBranch, String userName,
              String userUsername, String userEmail, String sourceRepoHomepage, String sourceRepoName, String sourceRepoFullName, String sourceNamespace, String sourceRepoUrl,
              ...
              Integer mergeRequestIid, Integer mergeRequestTargetProjectId, String targetBranch, String targetRepoName, String targetRepoFullName, String targetNamespace, String targetRepoSshUrl,
        ...
        this.sourceRepoFullName = Objects.requireNonNull(sourceRepoFullName, "sourceRepoFullName must not be null.");
        ...
        this.targetRepoFullName = Objects.requireNonNull(targetRepoFullName, "targetRepoFullName must not be null.");
    ...
    public enum ActionType {
    	...
    	private static String getForkNamespace(CauseData data) {
    		...
    		if (!StringUtils.equals(data.getSourceNamespace(), data.getTargetNamespace())) {
    			forkNamespace = data.getSourceNamespace() + "/" + data.getSourceRepoName() + "/";
    		} else if (!StringUtils.equals(data.getSourceRepoName(), data.getTargetRepoName())) {
    			forkNamespace = data.getSourceRepoName() + "/";
    		}
