...
public class GitLabPushTrigger extends Trigger<Job<?, ?>> implements MergeRequestTriggerConfig {
    ...
    public GitLabPushTrigger(boolean triggerOnPush, boolean triggerToBranchDeleteRequest, boolean triggerOnMergeRequest,
                             boolean triggerOnlyIfNewCommitsPushed, boolean rebuildSameCommitAllowed, boolean triggerOnAcceptedMergeRequest, boolean triggerOnClosedMergeRequest,
